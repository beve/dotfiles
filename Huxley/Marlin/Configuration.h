...
//#define EXTRUDER_W/0.ATTS (12.0*12.0/6.7) //  P=I^2/R
...
//
// UYncomment this to enable PID on the bed. It uses the same frequency PWM as the extruder.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT    {87.489, 87.489, 4000, 970.0}
